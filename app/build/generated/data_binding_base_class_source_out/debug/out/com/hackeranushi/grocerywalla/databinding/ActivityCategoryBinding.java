...
public final class ActivityCategoryBinding implements ViewBinding {
  ...
  private ActivityCategoryBinding(@NonNull RelativeLayout rootView, @NonNull AppBarLayout appBar,
      @NonNull RecyclerView categoryProduct, @NonNull Toolbar toolbar) {
  ...
  public static ActivityCategoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      RecyclerView categoryProduct = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ActivityCategoryBinding((RelativeLayout) rootView, appBar, categoryProduct,
          toolbar);
    }
