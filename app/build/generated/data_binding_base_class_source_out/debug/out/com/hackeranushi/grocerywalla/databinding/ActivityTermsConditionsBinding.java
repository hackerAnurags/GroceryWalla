...
public final class ActivityTermsConditionsBinding implements ViewBinding {
  ...
  private ActivityTermsConditionsBinding(@NonNull RelativeLayout rootView,
      @NonNull AppBarLayout appBar, @NonNull Toolbar toolbar, @NonNull WebView webView) {
  ...
  public static ActivityTermsConditionsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityTermsConditionsBinding((RelativeLayout) rootView, appBar, toolbar,
          webView);
    }
