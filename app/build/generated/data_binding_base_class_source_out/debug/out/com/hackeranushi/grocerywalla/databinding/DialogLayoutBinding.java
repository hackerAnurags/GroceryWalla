...
public final class DialogLayoutBinding implements ViewBinding {
  ...
  private DialogLayoutBinding(@NonNull RelativeLayout rootView, @NonNull ImageView close,
      @NonNull ImageView imageView, @NonNull Button okBtn, @NonNull TextView textView,
  ...
  public static DialogLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogLayoutBinding((RelativeLayout) rootView, close, imageView, okBtn, textView,
          textView2);
    }
