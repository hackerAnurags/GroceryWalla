...
public final class HomeProductBinding implements ViewBinding {
  ...
  @NonNull
  public static HomeProductBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static HomeProductBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.home_product, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static HomeProductBinding bind(@NonNull View rootView) {
